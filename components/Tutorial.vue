...
<template>
  <div class="relative flex items-top  margin-left:pt-7 justify-center bg-gray-100  sm:pt-5">

      <!-- <div class="relative flex items-top justify-center min-h-screen bg-gray-100  sm:pt-5"> -->
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <div>
          <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">Dish Title</p>
          <input class="form-control mr-sm-2" type="Name" placeholder="Recipe title" aria-label="title">
        </div>

        <div>
          <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">Pseudo</p>
          <input class="form-control mr-sm-2" type="Name" placeholder="Recipe title" aria-label="title">
        </div>

        <div>
          <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">Category</p>
          <input class="form-control mr-sm-2" type="Name" placeholder="Ex: pastas, fish..." aria-label="title">
        </div>

        <div>
          <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">Ingredients</p>
          <input class="form-control mr-sm-2" type="Name" placeholder="Ex: floor, eggs..." aria-label="title">
        </div>

        <div>
          <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">Please describe all the steps involved in preparing this dish </p>
          <input class="form-control mr-sm-2" type="Name" placeholder="Ex: Preheat the oven to 180%..." aria-label="title">
        </div>

        <div>
          <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">Add a photo</p>
