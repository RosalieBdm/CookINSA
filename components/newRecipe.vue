  ...
  <div class="relative flex items-top  margin-left:pt-7 justify-center bg-gray-100  sm:pt-5">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <div>
          <label class="mt-4 pt-4 text-gray-800 border-t border-dashed">Please describe all the steps involved in preparing this dish </label>
          <input v-model="rec.steps" class="form-control mr-sm-2" type="Name" placeholder="Ex: Preheat the oven to 180%..." aria-label="ste">
          <!-- <input v-model="rec.Pseudo" v-model.trim="pseudo" class="form-control mr-sm-2" type="Name" placeholder="Recipe title" aria-label="title"> -->
        </div>
        ...
        <button type="submit" class="button" @click="addRecipe">➕ Submit recipe >></button>
        <!-- <v-btn
            to="../pages/publishing.vue"
            @click="addRecipe"
            class="button">➕ Submit recipe !
        </v-btn> -->
...
<script>
  ...
  // import RecipeModel from "@/back/post.model.js/RecipeModel"
  ...
  export default {
    ...
    methods: {
      ...
      addRecipe() {
        ...
        // axios
        //   .post('http://localhost:3000/RecipeModel', {
        //     Title: 'title', 
        //     Pseudo: 'pseudo', 
        //     Category: 'category', 
        ...
        //   // .post('http://localhost:3000/RecipeModel', data())
    ...
    // async created() {
    //   this.message = await axios.get('http://localhost:3000/publishing');
    // }
  }
